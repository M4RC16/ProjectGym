...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    @Query("SELECT u.id as trainerId, CONCAT( u.lastName, ' ', u.firstName) as trainerName, u.description as description, u.profilePicture as profilePicture, u.hourlyWage as hourlyWage FROM User u WHERE u.role.id = 2")

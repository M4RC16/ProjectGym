...
import com.gymprojekt.projectgym.service.ReservationService;
...
public class ReservationController {
    ...
    public ResponseEntity<List<ReservationService.FreeTrainingResponse>> getFreeTrainings(@RequestBody TrainingRequest request) {
